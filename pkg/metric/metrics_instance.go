...
func InitSpiderpoolAgentMetrics(ctx context.Context, cache podownercache.CacheInterface) error {
	...
	if nil != err {
		return fmt.Errorf("failed to new spiderpool agent metric '%s', error: %v", autoPoolWaitedForAvailableCountsName, err)
	}
...
func initSpiderpoolAgentAllocationMetrics(ctx context.Context) error {
	...
	if nil != err {
		return fmt.Errorf("failed to new spiderpool agent metric '%s', error: %v", ipamAllocationCountsName, err)
	}
	...
	if nil != err {
		return fmt.Errorf("failed to new spiderpool agent metric '%s', error: %v", ipamAllocationFailureCountsName, err)
	}
	...
	if nil != err {
		return fmt.Errorf("failed to new spiderpool agent metric '%s', error: %v", ipamAllocationUpdateIPPoolConflictCountsName, err)
	}
	...
	if nil != err {
		return fmt.Errorf("failed to new spiderpool agent metric '%s', error: %v", ipamAllocationErrInternalCountsName, err)
	}
	...
	if nil != err {
		return fmt.Errorf("failed to new spiderpool agent metric '%s', error: %v", ipamAllocationErrNoAvailablePoolCountsName, err)
	}
	...
	if nil != err {
		return fmt.Errorf("failed to new spiderpool agent metric '%s', error: %v", ipamAllocationErrRetriesExhaustedCountsName, err)
	}
	...
	if nil != err {
		return fmt.Errorf("failed to new spiderpool agent metric '%s', error: %v", ipamAllocationErrIPUsedOutCountsName, err)
	}
	...
	if nil != err {
		return fmt.Errorf("failed to new spiderpool agent metric '%s', error: %v", ipamAllocationDurationSecondsName, err)
	}
	...
	if nil != err {
		return fmt.Errorf("failed to new spiderpool agent metric '%s', error: %v", ipamAllocationLimitDurationSecondsName, err)
	}
...
func initSpiderpoolAgentReleaseMetrics(ctx context.Context) error {
	...
	if nil != err {
		return fmt.Errorf("failed to new spiderpool agent metric '%s', error: %v", ipamReleaseCountsName, err)
	}
	...
	if nil != err {
		return fmt.Errorf("failed to new spiderpool agent metric '%s', error: %v", ipamReleaseFailureCountsName, err)
	}
	...
	if nil != err {
		return fmt.Errorf("failed to new spiderpool agent metric '%s', error: %v", ipamReleaseUpdateIPPoolConflictCountsName, err)
	}
	...
	if nil != err {
		return fmt.Errorf("failed to new spiderpool agent metric '%s', error: %v", ipamReleaseErrInternalCountsName, err)
	}
	...
	if nil != err {
		return fmt.Errorf("failed to new spiderpool agent metric '%s', error: %v", ipamReleaseErrRetriesExhaustedCountsName, err)
	}
	...
	if nil != err {
		return fmt.Errorf("failed to new spiderpool agent metric '%s', error: %v", ipamReleaseDurationSecondsName, err)
	}
	...
	if nil != err {
		return fmt.Errorf("failed to new spiderpool agent metric '%s', error: %v", ipamReleaseLimitDurationSecondsName, err)
	}
...
func initSpiderpoolControllerGCMetrics(ctx context.Context) error {
	...
	if nil != err {
		return fmt.Errorf("failed to new spiderpool controller metric '%s', error: %v", ipGCCCountsName, err)
	}
	...
	if nil != err {
		return fmt.Errorf("failed to new spiderpool controller metric '%s', error: %v", ipGCFailureCountsName, err)
	}
...
func initSpiderpoolControllerCRMetrics(ctx context.Context) error {
	...
	if nil != err {
		return fmt.Errorf("failed to new spiderpool controller metric '%s', error: %v", subnetTotalIPCountsName, err)
	}
	...
	if nil != err {
		return fmt.Errorf("failed to new spiderpool controller metric '%s', error: %v", subnetAvailableIPCountsName, err)
	}
	...
	if nil != err {
		return fmt.Errorf("failed to new spiderpool controller metric '%s', error: %v", ippoolTotalIPCountsName, err)
	}
	...
	if nil != err {
		return fmt.Errorf("failed to new spiderpool controller metric '%s', error: %v", ippoolAvailableIPCountsName, err)
	}
